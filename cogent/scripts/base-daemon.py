...
class DgRunner(runner.DaemonRunner):
    def _terminate_daemon_process(self):
        ...
        try:
            ...
            # DG- It may be the case that there is no such process (as
            # we killed it above) In this case exit as a success
            if exc[0] == 3:
...
class App:
    def __init__(self):
        ...
        self.pidfile_path = (
            "/home/dang/cogent-house-Main/djgoldsmith-devel/cogent/tmp.pid"
        )
