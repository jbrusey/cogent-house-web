...
class Location(meta.Base, meta.InnoDBMix):
    ...
    def __str__(self):
        return "Location {0}: {1} {2}".format(self.id, self.houseId, self.roomId)

    def __eq__(self, other):
        return self.houseId == other.houseId and self.roomId == other.roomId

    def __ne__(self, other):
        return not (self.houseId == other.houseId and self.roomId == other.roomId)
