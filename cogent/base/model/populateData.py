...
def populateSensorTypes(session=None):
    ...
    sensorList = [
        ...
        SensorType(
            id=2, name="Humidity", code="RH", units="%", c0=0.0, c1=1.0, c2=0.0, c3=0.0
        ),
        SensorType(
            id=3,
            name="Delta Humidity",
        ...
        SensorType(
            id=8, name="CO2", code="CO2", units="ppm", c0=0.0, c1=1.0, c2=0.0, c3=0.0
        ),
        SensorType(
            id=9,
            name="Air Quality",
        ...
        SensorType(
            id=10, name="VOC", code="VOC", units="ppm", c0=0.0, c1=1.0, c2=0.0, c3=0.0
        ),
        SensorType(
            id=11, name="Power", code="POW", units="W", c0=0.0, c1=1.0, c2=0.0, c3=0.0
        ),
        SensorType(
            id=12, name="Heat", code="HET", units="W", c0=0.0, c1=1.0, c2=0.0, c3=0.0
        ),
        SensorType(
            id=13,
            name="Duty cycle",
        ...
        SensorType(
            id=14, name="Error", code="ERR", units="", c0=0.0, c1=1.0, c2=0.0, c3=0.0
        ),
        SensorType(
            id=15,
            name="Power Min",
        ...
        SensorType(
            id=37, name="VOC Poor", code="VP", units="%", c0=0.0, c1=1.0, c2=0.0, c3=0.0
        ),
        SensorType(
            id=38,
            name="AQ Acceptable",
        ...
        SensorType(
            id=39, name="AQ Poor", code="AP", units="%", c0=0.0, c1=1.0, c2=0.0, c3=0.0
        ),
...
def _parseCalibration(filename, sensorcode, session=None):
    ...
    for row in reader:
        ...
        theSensor = (
            ...
            .filter_by(sensorTypeId=sensorType.id, nodeId=nodeId)
            .first()
        )
