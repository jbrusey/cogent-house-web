...
#         testbif = TestBif()
#         blogger = BaseLogger.BaseLogger(bif=testbif, dbfile="sqlite:///test.db")
...
#     #     session = self.Session()
#     #     out = BaseLogger.duplicate_packet(
#     #         session=session, receipt_time=now, node_id=4242, localtime=0
#     #     )
