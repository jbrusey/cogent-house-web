...
class TestRoom(base.ModelTestCase):
    ...
    def _dictobj(self):
        ...
        theDict = {"__table__": "Room", "id": 1, "name": "Test Room", "roomTypeId": 1}
        return theDict

    def testEq(self):
        """Test for Equality"""
        item1 = models.Room(id=1, name="Test Room", roomTypeId=1)
        item2 = models.Room(id=1, name="Test Room", roomTypeId=1)
